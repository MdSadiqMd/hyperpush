...
#[test]
fn m045_s04_historical_wrapper_alias_contract() {
    let verifier_path = repo_root().join("scripts").join("verify-m045-s04.sh");
...
#[test]
fn m045_s04_authoritative_cutover_dependency_contract() {
