...
README_REQUIRED_STRINGS=(
  ...
  'For the canonical distributed operator proof story, use **[Distributed Proof](https://meshlang.dev/docs/distributed-proof/)** and the repo runbook at [`cluster-proof/README.md`](https://github.com/snowdamiz/mesh-lang/blob/main/cluster-proof/README.md).'
)
REJECTED_STRINGS=(
  'placeholder link'
)
