...
RUNBOOK_LINK="https://github.com/snowdamiz/mesh-lang/blob/main/cluster-proof/README.md"
...
GUIDE_REQUIRED_STRINGS=(
  ...
  'https://github.com/snowdamiz/mesh-lang/blob/main/cluster-proof/README.md'
...
README_REQUIRED_STRINGS=(
  ...
  '[`cluster-proof/README.md`](https://github.com/snowdamiz/mesh-lang/blob/main/cluster-proof/README.md)'
  ...
  'For the canonical distributed continuity proof story, use **[Distributed Proof](https://meshlang.dev/docs/distributed-proof/)** and the repo runbook at [`cluster-proof/README.md`](https://github.com/snowdamiz/mesh-lang/blob/main/cluster-proof/README.md).'
)
