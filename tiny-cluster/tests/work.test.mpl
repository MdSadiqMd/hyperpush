...
describe("tiny-cluster package smoke") do
  ...
  test("manifest and source stay source-first and route-free") do
    let manifest = read_required_file("tiny-cluster/mesh.toml", "mesh.toml", "../mesh.toml")
    let main_source = read_required_file("tiny-cluster/main.mpl", "main.mpl", "../main.mpl")
    let work_source = read_required_file("tiny-cluster/work.mpl", "work.mpl", "../work.mpl")
  ...
  test("readme points operators to runtime-owned cli inspection") do
    let readme = read_required_file("tiny-cluster/README.md", "README.md", "../README.md")
