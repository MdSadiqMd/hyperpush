...
Plans:
- [x] 145-01-PLAN.md — Tailwind v4 + OKLCH design system foundation + API bug fixes (search param, versions endpoint in registry)
- [x] 145-02-PLAN.md — Redesign +layout.svelte (sticky navbar + dark mode + footer) + +page.svelte (hero + package grid)
- [x] 145-03-PLAN.md — Redesign package detail page (README prose + copy button + sidebar) + search results page
- [x] 145-04-PLAN.md — Build verification + human visual approval checkpoint
